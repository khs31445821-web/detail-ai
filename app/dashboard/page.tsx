...
function getProjectDestination(
            ...
            {projects.map((project) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`inline-flex rounded-full px-2.5 py-1 text-[11px] font-bold ${destination.color}`}
                  >
                    {destination.stage}
                  </span>
